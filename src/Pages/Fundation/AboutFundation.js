...
const AboutFundation = () => {
    return (  
        <main className="article article--justify">
            ...
            <a href="https://www.facebook.com/dtpsymirona" target="_blank" rel="noreferrer" className="home-page__support">
                <div className="about-fundation__link-text">
                    Poznaj nasze przedmatuzalkowe życie, odwiedzając profil DT PSY MIRONA na Facebooku
                </div>
            </a>
